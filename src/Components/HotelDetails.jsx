...
const defaultMealOptions = [
  { id: "meal-1", name: "Breakfast", isDefault: true },
  { id: "meal-2", name: "Lunch", isDefault: true },
  { id: "meal-3", name: "Dinner", isDefault: true },
  { id: "meal-4", name: "MAP", isDefault: true },
  { id: "meal-5", name: "CP", isDefault: true },
];

const defaultRoomOptions = [
  { id: "room-1", name: "Deluxe Room", isDefault: true },
  { id: "room-2", name: "Super Deluxe", isDefault: true },
  { id: "room-3", name: "Suite", isDefault: true },
  { id: "room-4", name: "Family Room", isDefault: true },
  { id: "room-5", name: "Standard Room", isDefault: true },
];
...
const HotelDetails = () => {
  ...
  const openEdit = (hotel) => {
    setImagePreview(hotel.hotel_image_url || "");
  ...
  const handleDelete = async (hotel) => {
    if (!window.confirm("Kya aap is hotel ko delete karna chahte hain?"))
      return;
